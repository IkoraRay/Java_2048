...
public class Jogo extends JPanel implements KeyListener, Runnable { // faz contrato de KeyListener e Runnable e extende JPanel
	...
	private Thread jogo; //cria uma thread para realizar processos paralelos
	...
	public Jogo() { 
		...
		addKeyListener(this); //permite a entrada do teclado em um Jogo
		
		interfaceJogo = new Interface(LARGURA / 2 - Interface.LARGURA_INTERFACE / 2, ALTURA - Interface.ALTURA_INTERFACE - 10); //chama classe Interface, que inicia o jogo 
																																// com tamanhos definidos nesta classe
	...
	private void processa() {
		...
		interfaceJogo.desenhoGeral(graficos);
	...
	public void run() {
		...
		if (System.currentTimeMillis() - tempoFps > 1000) { // se for maior que 1 segundo
			...
			tempoFps += 1000; // aumenta 1 segundo
		}
